...
for i in 1:size(M, 2)
    ...
    arrows!(tovec(point)..., tovec(Xz(point))...; arrowsize = Vec3f0(0.1, 0.1, 0.1), color=:black)
    arrows!(tovec(point)..., tovec(Xy(point))...; arrowsize = Vec3f0(0.1, 0.1, 0.1), color=:red)
    arrows!(tovec(point)..., tovec(Xx(point))...; arrowsize = Vec3f0(0.1, 0.1, 0.1), color=:green)
